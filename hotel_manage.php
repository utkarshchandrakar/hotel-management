...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="ucphenomenal99@gmail.com">risk6565@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9876532122</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html">Hotel <span>Inn</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
						    ...
						    <li class="menu__item"><a href="#food" class="menu__link scroll">Food</a></li>
						</ul>
					</nav>
				</div>
			</nav>
							...
							<div class="container">
								...
								<h4>Kankariya Hotels</h4>
									<h3>Stay with your friends & families</h3>
										<p>Come & enjoy precious moment with your loved ones</p>
									<div class="agileits_w3layouts_more menu__item">
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Learn More</a>
			</div>
								</div>	
...
<div class="col-md-3 book-form-left-w3layouts">
	<h2><a href="admin/reservation.php">CHECK AVAILABILITY</a></h2>
</div>
<div class="col-md-9 book-form">
			   <form action="#" method="post">
					...
					<div class=" form-left-agileits-submit">
						  <input type="submit" value="Check Availability" href="reservation.php">
					</div>
				</form>
			</div>
			<div class="clearfix"> </div>
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>Experience the best stay, enjoy fantastic views</span> Find our too much friendly welcoming reception</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Hotel Inn</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Hotel Inn</h3> 
						   <p class="about-para-w3ls">Our team members work 24/7 to provide the experience you expected to get while entering a word class hotel </p>
		   ...
		   <div class="advantage-bottom">
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					...
					<p><i class="fa fa-check" aria-hidden="true"></i>Personal refrigerator and microwave.</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>LED TV with Full subscription.</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					...
					<p><i class="fa fa-check" aria-hidden="true"></i>24-hour telephone service</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>24-hour gymming service</p>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/t.png" alt=" " class="img-responsive" height="90px" width="80px" />
					</li>
					<li>
						<img src="images/m.jpg" alt=" " class="img-responsive" height="90px" width="90px" />
					</li>
					<li>
						<img src="images/o.jpg" alt=" " class="img-responsive" width="110px"/>
					</li>
					<li>
						<img src="images/l.jpg" alt=" " class="img-responsive" width="85px" />
					</li>
					</ul>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Lucas Jimenez</h4>
							<span>Manager</span>
							<p>Come and get some experience that you have never felt before from our manager</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>This receptionist is the most attractive receptionist you've ever seen.Come and have a look at this hot brunette</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Ivan Simpson</h4>
							<span>Manager</span>
							<p>our managing team is governed by Mr.Ivan Simpson who was former manager of taj group of hotels  </p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<span>Receptionist</span>
							<p>This recptionist can attract any girl with a smile.So,you are responsible for your own belongings.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>The best hotel i have ever experienced 
									The best hotel i have ever experienced  </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>The best hotel i have ever experienced  </p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong> +91 9827143890</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:ucphenomenal99@gmail.com">risk6565@gmail.com</a></p>
